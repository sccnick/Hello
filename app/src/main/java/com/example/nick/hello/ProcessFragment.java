...
import com.example.nick.hello.adapter.ProcessAdapter;
...
public class ProcessFragment extends Fragment {
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        listView =(ListView)rootView.findViewById(R.id.lvProcess);
        process = new ProcessAdapter();
        listView.setAdapter(process);
        process.notifyDataSetChanged();
    }
